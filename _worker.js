...
// Variables
const rootDomain = "saingsaputra.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "muhsaing"; // Ganti dengan nama workers kalian
const apiKey = "LiLCYXK24cWccTmspLVzzWVcjtyl9t_3GzJhZE9E"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "saingsaputra@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "97d618d0e01a2d3963cb8368c8399e2b"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
